...
def test_similar():
    orig = Photo.from_file(str(STATIC_DIR / "08-190641-4631.jpeg"))
    modified = Photo.from_file(str(STATIC_DIR / "08-190641-4631-modified.jpeg"))
    ...
    unrelated = Photo.from_file(str(STATIC_DIR / "25-121007-33d0.jpeg"))
